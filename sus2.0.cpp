...
txRectangle (0,350,1000,800); //zemlia
}
...
txRectangle (0,600,1000,800);  //pole
}
...
txSetColor (RGB (128,128,128), 5);
txSetFillColor (TX_GREEN);
txRectangle (0,400,1000,600);  //zabor
}
...
txSetFillColor (RGB (128,128,128));
txLine (960,400,1000,600);  //zabor snizu verh
}
...
txSetFillColor (RGB (128,128,128));
txLine (1000,400,960,600);  //zabor sverhu vniz
}
...
txSetColor (RGB (139, 69, 19), 5);
txSetFillColor (RGB (139, 69, 19));
txRectangle(150,390,190,420) ; //levoe derevo
}
...
txSetColor (RGB (139, 69, 19), 5);
txSetFillColor (RGB (139, 69, 19));
txRectangle(800,320,820,425) ;//pravoe derevo
}
...
txLine (760,400,800,600);
txSetFillColor (RGB (128,128,128));
txLine (800,400,760,600);       //zabor pered pravim derevom
}
...
txSetFillColor (RGB (128,128,128));
txLine (160,400,120,600);
txRectangle (0,400,1000,401); //zabor pered levim derevom
}
...
txRectangle (480,325,520,600);//stolb
}
...
txRectangle (300,150,700,325);//shit
}
...
txRectangle(375,175,625,300); //na shite
}
...
txLine (540,200,540,220);  //strelki
}
...
txEllipse (400,250,600,300); //kol'cho
}
