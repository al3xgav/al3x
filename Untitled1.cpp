...
txRectangle (0,350,1000,800); //трава
}
...
txLine (0,603,1000,603);//маркировка поля
}
...
txSetFillColor (RGB (128,128,128));
txLine (960,400,1000,600);  //забор снизу вверх
}
...
txSetFillColor (RGB (128,128,128));
txLine (1000,400,960,600);  //забор сверху вниз
}
...
txSetColor (RGB (139, 69, 19), 5);
txSetFillColor (RGB (139, 69, 19));
txRectangle(150,390,190,420) ; //дерево за забором л.
}
...
txSetColor (RGB (139, 69, 19), 5);
txSetFillColor (RGB (139, 69, 19));
txRectangle(800,320,820,425) ;//правое дерево за забором
}
...
txLine (760,400,800,600);
txSetFillColor (RGB (128,128,128));
txLine (800,400,760,600);       //забор перед правым деревом
}
...
txRectangle(375,175,625,300); //маркировка на щите
}
...
txLine (540,200,540,220);  //стрелки
}
...
txSetFillColor(RGB (240, 230, 140));
txSetColor(RGB (240, 230, 140),5);
txRectangle(898,530,913,550);//шея
}
